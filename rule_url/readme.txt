1.需要python环境2.7/3.6
2.使用方式:python 脚本名 url [可选参数n：数字] [可选参数b：True/False]
3.可选参数n的作用：指定从第几个'/'（不计算'://'中的'/'）之前的字符串作为前缀，之后的正则化  默认为1
